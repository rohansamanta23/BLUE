  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      if (subRowRef.current)
        subRowRef.current.classList.add("hero__subrow--animate");
      if (scrollbarRef.current)
        scrollbarRef.current.classList.add("hero__scrollbar--animate");
      if (counterRef.current)
        counterRef.current.classList.add("hero__counter--animate");
    }, 100);
